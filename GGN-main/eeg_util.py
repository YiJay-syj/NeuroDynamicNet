...
def get_common_args():
    ...
    parser.add_argument('--seed', type=int, default=1992, help='seed')
    ...
    parser.add_argument('--dataset', type=str, default='TUH', help='SEED, SEED_IV')
    ...
    parser.add_argument('--adj_file', type=str, default='./adjs/raw_adj.npy',
                        help='adj data path')
    parser.add_argument('--adj_type', type=str, default='origin', help='adj type', choices=ADJ_CHOICES)
    ...
    parser.add_argument('--weighted_ce', type=str, default='prop', help='weighted cross entropy opt')
    ...
    parser.add_argument('--best_model_save_path', type=str, default='./saved_models/GGN_model.pt', help='best_model')
    ...
    parser.add_argument('--gnn_layer_num', type=int, default=2, help='gnn_layer_num')
    parser.add_argument('--gnn_hid_dim', type=int, default=32, help='gnn_hid_dim')
    parser.add_argument('--gnn_out_dim', type=int, default=16, help='gnn_out_dim')
    ...
    parser.add_argument('--feature_len', type=int, default=48, help='input feature_len')
    ...
    parser.add_argument('--predict_class_num', type=int, default=7, help='predict_class_num')
    ...
    # NOTE: decoder param:
    parser.add_argument('--cut_encoder_dim', type=int, default=-0, help='cut_encoder_dim')
    parser.add_argument('--decoder', type=str, default='lgg_cnn', help='decoder')
    ...
    parser.add_argument('--lgg_warmup', type=int, default=5, help='lgg_warmup')
    parser.add_argument('--lgg_tau', type=float, default=0.01, help='gumbel softmax tau')
    parser.add_argument('--lgg_hid_dim', type=int, default=64, help='lgg_hid_dim')
    parser.add_argument('--lgg_k', type=int, default=5, help='lgg k component')
    ...
    parser.add_argument(
        '--use_dynamic_in_st_hggn',
        action='store_true',
        default=False,
        help='在 ST-HGGN 中按照 “GGN→时空衰减→层次化→最后动态加权” 的顺序，是否在最后一步启用 DCW（默认关闭）'
    )
